document.addEventListener('DOMContentLoaded',()=> {
  ...
  fetch('ski-resort-data.json')
      ...
      .then(resortData => {
          ...
          const baseDepthRaceData = transformDataForRace(resortData.BaseDepth, colorGradientBaseDepth);
          const trailsRaceData = transformDataForRace(resortData.Trails, colorGradientTrails);
  ...
  function createBarChartRace(containerId, raceData, chartTitle, xAxisTitle, interval, controlId) {
      ...
      // Apply monospace font to Y-axis labels with responsive font size
      ...
      const axisTitleFontSize = isMobile() ? 11 : 13;
      ...
      series.bullets.push(function() {
          ...
          bullet.get("sprite").adapters.add("text", function(text, target) {
              return target.dataItem ? target.dataItem.get("valueX") : "";
          });
