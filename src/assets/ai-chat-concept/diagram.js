...
const planContent = {
  ...
  weights: {
    ...
    html: `
      <div class="flow-card p-3 bg-slate-50/60">
        <!-- Row 1: Open weight models -->
        <div class="grid grid-cols-3 gap-2">
          ...
          <div class="flow-card p-3 flex flex-col">
            <div class="flex items-center gap-2.5 mb-1.5">
              ...
              <div>
                <div class="text-[10px] text-slate-400 font-medium uppercase tracking-wide">Meta</div>
                <div class="text-xs font-semibold text-slate-700">LLaMA</div>
              </div>
            </div>
            <div class="flex gap-1 flex-wrap mb-2">
              <span class="tech-chip">3.2 · 1B</span>
              <span class="tech-chip">3.3 · 8B</span>
              <span class="tech-chip">3.3 · 70B</span>
              <span class="tech-chip">128k ctx</span>
            </div>
          ...
          <div class="flow-card p-3 flex flex-col">
            <div class="flex items-center gap-2.5 mb-1.5">
              ...
              <div>
                ...
                <div class="text-xs font-semibold text-slate-700">Qwen</div>
              </div>
            </div>
            <div class="flex gap-1 flex-wrap mb-2">
              <span class="tech-chip">Qwen3 · 4B</span>
              <span class="tech-chip">Qwen3 · 14B</span>
              <span class="tech-chip">Qwen3 · 235B</span>
              <span class="tech-chip">128k ctx</span>
            </div>
            <div class="mt-auto text-center text-[11px] font-semibold uppercase tracking-wide py-1.5 rounded-md" style="background:#dcfce7;color:#15803d">Open</div>
          </div>
          ...
          <div class="flow-card p-3 flex flex-col">
            <div class="flex items-center gap-2.5 mb-1.5">
              ...
              <div>
                ...
                <div class="text-xs font-semibold text-slate-700">Gemma</div>
              </div>
            </div>
            <div class="flex gap-1 flex-wrap mb-2">
              <span class="tech-chip">Gemma 3 · 1B</span>
              <span class="tech-chip">Gemma 3 · 12B</span>
              <span class="tech-chip">Gemma 3 · 27B</span>
              <span class="tech-chip">128k ctx</span>
            </div>
            <div class="mt-auto text-center text-[11px] font-semibold uppercase tracking-wide py-1.5 rounded-md" style="background:#dcfce7;color:#15803d">Open</div>
          </div>
      ...
      <div class="flow-card p-3 bg-slate-50/60 mt-4">
        <!-- Row 2: Closed weight models -->
        <div class="grid grid-cols-3 gap-2">
          ...
          <div class="flow-card p-3 flex flex-col">
            <div class="flex items-center gap-2.5 mb-1.5">
              ...
              <div>
                ...
                <div class="text-xs font-semibold text-slate-700">Claude</div>
              </div>
            </div>
            <div class="flex gap-1 flex-wrap mb-2">
              <span class="tech-chip">Haiku</span>
              <span class="tech-chip">Sonnet (fast)</span>
              <span class="tech-chip">Opus (Plan + front end)</span>
            </div>
          ...
          <div class="flow-card p-3 flex flex-col">
            <div class="flex items-center gap-2.5 mb-1.5">
              ...
              <div>
                ...
                <div class="text-xs font-semibold text-slate-700">GPT + Codex App (Cursor, T3 Code)</div>
              </div>
            </div>
            <div class="flex gap-1 flex-wrap mb-2">
              <span class="tech-chip">GPT-5.5 (Best back end code)</span>
              <span class="tech-chip">GPT-5.4</span>
              <span class="tech-chip">o4-mini</span>
              <span class="tech-chip">Codex</span>
            </div>
            <div class="mt-auto text-center text-[11px] font-semibold uppercase tracking-wide py-1.5 rounded-md" style="background:#fee2e2;color:#b91c1c">Closed</div>
          </div>
          ...
          <div class="flow-card p-3 flex flex-col">
            <div class="flex items-center gap-2.5 mb-1.5">
              ...
              <div>
                <div class="text-[10px] text-slate-400 font-medium uppercase tracking-wide">Google</div>
                <div class="text-xs font-semibold text-slate-700">Gemini</div>
              </div>
            </div>
            <div class="flex gap-1 flex-wrap mb-2">
              <span class="tech-chip">Gemini 3.1 Pro</span>
              <span class="tech-chip">Gemini 3.1 Flash</span>
              <span class="tech-chip">Nano Banana</span>
            </div>
            <div class="mt-auto text-center text-[11px] font-semibold uppercase tracking-wide py-1.5 rounded-md" style="background:#fee2e2;color:#b91c1c">Closed</div>
          </div>
