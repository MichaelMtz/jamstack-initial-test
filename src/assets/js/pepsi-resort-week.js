 ...
 */
const PEPSI_CONFIG = {
  TARGET_RESORT_ID: '702002',  
  YOUTUBE_VIDEO_ID: '8v1EyswwZec',
  VIDEO_DIMENSIONS: {
    width: '100%',
    height: '400px'
  },
      ...
      <div class="pepsi-content flex flex-col gap-1">
        <div class="pepsi-header flex flex-col gap-1">
          <div class="pepsi-logo-container items-center md:items-base md:px-4 flex flex-col md:flex-row md:gap-x-[100px] justify-center">   
            ...
            <svg class="lee-canyon" width="340px" height="92px" viewBox="0 0 170 46" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
